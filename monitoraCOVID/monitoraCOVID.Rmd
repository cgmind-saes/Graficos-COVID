...
A evolução de novos casos no Brasil pode ser vista no gráfico a seguir. A evolução geral  sugere que uma nova onda está em seu início nos últimos dias.
...
graf_07+ggtitle("Gráfico 7 - Taxas de transmissão (Rt) estimadas de COVID-19 - UFs do Brasil - últimos 60 dias")+scale_colour_manual(values=sample(c(paleta7,paleta5,paleta3,paleta4,paleta6),28))+theme_minimal()
