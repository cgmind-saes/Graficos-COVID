...
graf_07+ggtitle("Gráfico 7 - Taxas de transmissão (Rt) estimadas de COVID-19 - UFs do Brasil - últimos 60 dias")+scale_colour_manual(values=sample(c(paleta7,paleta5,paleta3,paleta4,paleta6),27))
